        ...
        return (
            <Contents>
                <div className='Centerbox'>
                    <div className="logo">
                        <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1580727104224&di=a934c2b465d735d62dbe924fbd1686b0&imgtype=0&src=http%3A%2F%2Fwww.hfhey.com%2Fupload%2Fimage%2F20150730%2F20150730143749774977.jpg" alt="" />
                    </div>
                    <div className="radio">
                    ...
                    {/* 性别 */}
                    <div className="sex">
                        <Select defaultValue="男" style={{ width: 120 }} onChange={(value)=>this.handleChange(value)}>
                    ...
                    <span onClick={() => { router.push('/login')}}>已有账号，立即登录</span>
                    </div>
                </div>
            </Contents>
        )
