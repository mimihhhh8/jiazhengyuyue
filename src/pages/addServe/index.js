...
class Addinfo extends Component {
  ...
  render() {
    ...
    return (
      <Addserve>
        {typeof this.state.list.serviceInfo === 'undefined' ? null : (
          <Card title="完善信息" bordered={false} style={{ width: 400 }}>
              ...
              <Form.Item label="员工姓名">
                {getFieldDecorator('workername', {
                  ...
                  <Input
                    type="text"
                    disabled={true}
                    placeholder={this.state.list.username}
                    onChange={e => {
              ...
              <Form.Item label="员工地址">
                {getFieldDecorator('workeraddress', {
                  ...
                  <Input
                    ...
                    placeholder={
                      this.state.list.serviceInfo.length === 1
                        ? this.state.list.serviceInfo[0].workeraddress
                        : null
                    }
                    type="text"
                    onChange={e => {
                      this.setState({ workeraddress: e.target.value });
                    }}
                  />,
                )}
              </Form.Item>
              <Form.Item label="服务类型">
                {getFieldDecorator('servicetype', {
                  ...
                  <Input
                    ...
                    placeholder={
                      this.state.list.serviceInfo.length === 1
                        ? this.state.list.serviceInfo[0].servicetype
                        : null
                    }
                    type="text"
                    onChange={e => {
              ...
              <Form.Item label="任务">
                {getFieldDecorator('task', {
                  ...
                  <Input
                    ...
                    placeholder={
                      this.state.list.serviceInfo.length === 1
                        ? this.state.list.serviceInfo[0].task
                        : null
                    }
                    type="text"
                    onChange={e => {
              ...
              <Form.Item label="工作年限">
                {getFieldDecorator('experience', {
                  ...
                  <Input
                    ...
                    placeholder={
                      this.state.list.serviceInfo.length === 1
                        ? this.state.list.serviceInfo[0].experience
                        : null
                    }
                    type="text"
                    onChange={e => {
              ...
              <Form.Item label="（小时/元）">
                {getFieldDecorator('char', {
                  ...
                  <Input
                    ...
                    placeholder={
                      this.state.list.serviceInfo.length === 1
                        ? this.state.list.serviceInfo[0].char
                        : null
                    }
                    type="text"
                    onChange={e => {
            ...
            {this.state.list.serviceInfo.length === 1 ? (
              <Button type="primary" className="center" disabled={true}>
                已完善
              </Button>
            ) : (
              <Button type="primary" className="center" onClick={() => this.handleData()}>
                确定完善
              </Button>
            )}
          </Card>
